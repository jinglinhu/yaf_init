...
class Log_Log
{
     ...
     * @return void
     */
    public static function debug($message, $record = false, $save = false, $class = '')
    {
     ...
     * @return void
     */
    public static function info($message, $record = false, $save = false, $class = '')
    {
     ...
     * @return void
     */
    public static function warn($message, $record = false, $save = false, $class = '')
    {
     ...
     * @return void
     */
    public static function error($message, $record = false, $save = false, $class = '')
    {
     ...
     * @return void
     */
    public static function record($message, $level = self::ERROR, $record = false, $save = false, $class = '')
    {
        ...
        if ($record || false !== strpos(Util_Conf::get('log.level'), $level)) {
     ...
     * @return void
     */
    public static function save($save = false, $type = '', $destination = '')
    {
        if (empty(self::$_log)) {
            return;
        }
        ...
        if (!self::$_storage) {
            $type = $type ? $type : Util_Conf::get('log.type');
     ...
     * @return void
     */
    public static function write($message, $level = self::ERROR, $type = '', $destination = '', $class = '')
    {
        if (!self::$_storage) {
            $type           = $type ? $type : Util_Conf::get('log.type');
            $drive          = 'Log_Driver_' . ucwords($type);
     ...
     * @return string
     */
    private static function _generateDestination($destination = '', $class = '')
    {
